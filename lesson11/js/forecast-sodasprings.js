...
const SSapiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&appid=036f9f0a4afb3430bbf52e171aad4ae6"
...
const SSapiforecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=036f9f0a4afb3430bbf52e171aad4ae6"

fetch(SSapiforecastURL)
    .then((response) => response.json())
    .then((jsObject) => {
